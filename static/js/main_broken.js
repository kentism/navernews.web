...
function removeSearchTab(id) {
    ...
    if (lastSearchTab) {
        ...
        // If no tabs left, show empty container or stay blank
        // (Here we assume 'searchPanelsContainer' might be a fallback ID, 
        // but usually we just leave it be or switch to clippings if available)
        // For safety, just ensure no active class on removed elements
    }
}
